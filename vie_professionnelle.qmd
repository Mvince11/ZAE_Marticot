...
<h1 style="font-size:1.4em;">Volet vie professionnelle</h1>

::: {style="text-align:center; font-size:1.2em; margin:10px 0;"}
...
p <- ggplot(ds_plot, aes(
  ...
  geom_col(show.legend = FALSE) +
  labs(
    title = "Combien y a-t-il de salariés dans votre entreprise ?",
    x = "",
    y = "Nombre de personnes",
    fill = NULL
  ) +
